				...
				function (t, n, e) {
					var r = e(6),
						...
						i = function (t, n) {
							var e = u[a(t)];
							return (
								e == f || (e != c && ('function' == typeof n ? r(n) : !!n))
							);
						},
						...
						{ target: 'Array', proto: !0 },
						{
							flat: function () {
								var t = arguments.length ? arguments[0] : void 0,
									...
									r = c(n, 0);
								return (
									(r.length = o(r, n, n, e, 0, void 0 === t ? 1 : u(t))), r
								);
							},
						}
					);
					...
					var r = e(45),
						...
						a = function (t, n, e, u, c, f, s, l) {
							for (var p, h = c, v = 0, g = !!s && i(s, l, 3); v < u; ) {
								if (v in e) {
									if (((p = g ? g(e[v], v, n) : e[v]), f > 0 && r(p)))
										h = a(t, n, p, o(p.length), h, f - 1) - 1;
									else {
				...
				function (t, n, e) {
					...
					t.exports = function (t) {
						var n,
							...
							b = 0;
						if (
							(x && (y = r(y, d > 2 ? arguments[2] : void 0, 2)),
							null == m || (g == Array && a(m)))
						)
							for (e = new g((n = u(v.length))); n > b; b++)
								(h = x ? y(v[b], b) : v[b]), c(e, b, h);
						else
							for (
								p = (l = m.call(v)).next, e = new g();
								!(s = p.call(l)).done;
								b++
							)
							...
							slice: function (t, n) {
								...
								if (
									...
									(e !== Array && !i(e.prototype))
										? o(e) && null === (e = e[g]) && (e = void 0)
										: (e = void 0),
									e === Array || void 0 === e)
								)
									return d.call(l, h, v);
								for (
									r = new (void 0 === e ? Array : e)(y(v - h, 0)), s = 0;
									h < v;
									h++, s++
								)
									h in l && f(r, s, l[h]);
						...
						{ target: 'Array', proto: !0, forced: !p || !h },
						{
							splice: function (t, n) {
								...
								if (((s.length = r), e < r)) {
									...
									for (l = y - r; l > x; l--)
										(h = l + e - 1),
											(p = l + r - 1) in d ? (d[h] = d[p]) : delete d[h];
				...
				function (t, n, e) {
					var r = e(2),
						...
						s = function (t, n, e) {
							var r = e.charAt(n - 1),
								o = e.charAt(n + 1);
							return (c.test(t) && !f.test(o)) || (f.test(t) && !c.test(r))
				...
				function (t, n, e) {
					...
					(t.exports = function (t, n, e, s, l) {
						...
						for (y = p.next; !(x = y.call(p)).done; )
							if (
								'object' == typeof (d = c(p, m, x.value, s)) &&
								d &&
								d instanceof f
							)
								return d;
					...
					t.exports = {
						...
						setStrong: function (t, n, e) {
							...
							f(
								...
								function () {
									for (
										var t = i(this), n = t.kind, e = t.last;
										e && e.removed;
					...
					t.exports =
						...
						o(function () {
							...
							return (
								...
								7 != s({}, t)[e] ||
									'abcdefghijklmnopqrst' != i(s({}, n)).join('')
							);
						})
							? function (t, n) {
									for (
										var e = c(t), o = arguments.length, s = 1, l = a.f, p = u.f;
										o > s;
				...
				function (t, n, e) {
					var r = e(5),
						...
						u = function (t) {
							return function (n) {
								for (
									var e, u = i(n), c = o(u), f = c.length, s = 0, l = [];
									f > s;
					...
					r(
						{ target: 'Object', stat: !0, sham: !o },
						{
							getOwnPropertyDescriptors: function (t) {
								for (
									var n, e, r = a(t), o = u.f, f = i(r), s = {}, l = 0;
									f.length > l;
								...
								R(function () {
									for (
										...
										try {
											l
												? (i ||
														(2 === n.rejection && nt(t, n), (n.rejection = 1)),
												  !0 === l
														? (u = o)
														: (v && v.enter(),
														  (u = l(o)),
					...
					if (
						...
						for (
							var w = function (t, n) {
									...
									S
										? o && !i && (t = t.source)
										: t instanceof w && (i && (n = s.call(t)), (t = t.source)),
										E &&
											(e = !!n && n.indexOf('y') > -1) &&
											(n = n.replace(/y/g, ''));
						...
						A = o(
							...
							function () {
								...
								return null === r
									...
									: t.global
									? ('' == String(r[0]) &&
											(n.lastIndex = d(e, a(n.lastIndex), t.unicode)),
									  { value: r, done: !1 })
						...
						u = function (t) {
							return function (n, e, u) {
								...
								return h <= l || '' == p
									? s
									: ((c = h - l),
									  (f = o.call(p, a(c / p.length))).length > c &&
											(f = f.slice(0, c)),
									  t ? s + f : f + s);
							};
						};
						...
						return [
							...
							function (t, r) {
								...
								for (var S = []; ; ) {
									...
									if ((S.push(E), !g)) break;
									'' === String(E[0]) &&
										(c.lastIndex = f(h, a(c.lastIndex), b));
								}
								for (var w, O = '', R = 0, A = 0; A < S.length; A++) {
									E = S[A];
									for (
										var j = String(E[0]),
											I = l(p(u(E.index), h.length), 0),
											k = [],
											P = 1;
										P < E.length;
										P++
								...
								[
									...
									function (t, o) {
										...
										for (var b = 0, S = 0, E = []; S < p.length; ) {
											...
											if (
												null === O ||
												(w = v(f(x.lastIndex + (g ? 0 : S)), p.length)) === b
											)
												S = c(p, S, d);
											else {
					...
					o(
						...
						},
						{
							startsWith: function (t) {
								...
								u(t);
								var e = a(
										p(arguments.length > 1 ? arguments[1] : void 0, n.length)
									),
									r = String(t);
						...
						i(d, {
							...
							get: function (t) {
								if (f(t) && !h(t)) {
									...
									return (
										n.frozen || (n.frozen = new r()),
										x.call(this, t) ? m.call(this, t) : n.frozen.get(t)
									);
								}
							...
							set: function (t, n) {
								if (f(t) && !h(t)) {
									...
									e.frozen || (e.frozen = new r()),
										x.call(this, t) ? b.call(this, t, n) : e.frozen.set(t, n);
										...
										if (!I.test(a)) {
											if (
												...
												if ('' != v) {
													...
													(t.port = X(t) && S === V[t.scheme] ? null : S),
														(v = '');
												}
												if (e) return;
												s = dt;
						...
						(i &&
							c(wt, {
								...
								port: Ct(Lt, function (t) {
									var n = w(this);
									K(n) ||
										('' == (t = String(t)) ? (n.port = null) : St(n, t, pt));
								}),
								...
								if (d(f))
									if ('function' == typeof (t = b(f)))
										for (e = (n = t.call(f)).next; !(r = e.call(n)).done; ) {
											if (
												(a = (i = (o = m(g(r.value))).next).call(o)).done ||
												(u = i.call(o)).done ||
												!i.call(o).done
											)
										...
										return (
											arguments.length > 1 &&
												...
												d(n) &&
													((e = n.body),
													'URLSearchParams' === v(e) &&
														((r = n.headers ? new w(n.headers) : new w()).has(
															'content-type'
														) ||
															r.set(
																'content-type',
...
*/
					...
					var n = (function e(n, t, r) {
						...
						var l = Promise.resolve()
							...
							.then(function (e) {
								...
								return (
									(o.e = r.execute || function () {}), [e[0], r.setters || []]
								);
							});
								...
								(u.charset = 'utf-8'),
									...
									u.addEventListener('error', function () {
										window.removeEventListener('error', c),
											o(Error('Error loading ' + e + (n ? ' from ' + n : '')));
									}),
									u.addEventListener('load', function () {
										window.removeEventListener('error', c),
											document.head.removeChild(u),
											i ? o(i) : r(t.getRegister());
									}),
									(u.src = e),
						...
						if (
							...
							if (
								((r =
									'/' === n[t.length + 1]
										? 'file:' !== t
											? (r = n.slice(t.length + 2)).slice(r.indexOf('/') + 1)
											: n.slice(8)
										: n.slice(t.length + ('/' === n[t.length]))),
								'/' === e[0])
							)
							...
							return (
								...
								n.slice(0, n.length - r.length) + i.join('')
							);
						}
					})(e, n || t);
					if (!o) {
		...
		var scriptElm =
			...
			Array.from(document.querySelectorAll('script')).find(function (s) {
				return (
					regex.test(s.src) ||
					s.getAttribute('data-stencil-namespace') === 'ionicons'
				);
			});

		var resourcesUrl = scriptElm
			? scriptElm.getAttribute('data-resources-url') || scriptElm.src
			: '';
		var start = function () {
			var url = new URL(
				'./p-af44f89e.system.js',
				new URL(resourcesUrl, window.location.origin)
			);
